      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            ...
            <li><a href="festivaltap.php?a=<?php echo "충남";?>&location=축제&b=10&page=1">예산</a></li>
            <li><a href="festivaltap.php?a=<?php echo "충남";?>&location=축제&b=11&page=1">천안</a></li>
            <li><a href="festivaltap.php?a=<?php echo "충남";?>&location=축제&b=12&page=1">청양</a></li>
            <li><a href="festivaltap.php?a=<?php echo "충남";?>&location=축제&b=13&page=1">태안</a></li>
            <li><a href="festivaltap.php?a=<?php echo "충남";?>&location=축제&b=14&page=1">홍성</a></li>
            <li><a href="festivaltap.php?a=<?php echo "충남";?>&location=축제&b=15&page=1">계롱</a></li>
          </ul>
        </li>
        <li>
        ...
        <li>
          ...
          <ul>
            ...
            <li><a href="festivaltap.php?a=<?php echo "전남";?>&location=축제&b=14&page=1">영광</a></li>
            <li><a href="festivaltap.php?a=<?php echo "전남";?>&location=축제&b=15&page=1">영암</a></li>
            <li><a href="festivaltap.php?a=<?php echo "전남";?>&location=축제&b=16&page=1">완도</a></li>
            <li><a href="festivaltap.php?a=<?php echo "전남";?>&location=축제&b=17&page=1">장성</a></li>
            <li><a href="festivaltap.php?a=<?php echo "전남";?>&location=축제&b=18&page=1">장흥</a></li>
            <li><a href="festivaltap.php?a=<?php echo "전남";?>&location=축제&b=19&page=1">진도</a></li>
            <li><a href="festivaltap.php?a=<?php echo "전남";?>&location=축제&b=20&page=1">함평</a></li>
            <li><a href="festivaltap.php?a=<?php echo "전남";?>&location=축제&b=21&page=1">해남</a></li>
            <li><a href="festivaltap.php?a=<?php echo "전남";?>&location=축제&b=22&page=1">화순</a></li>
          </ul>
        </li>
        <li>
          <a href="festivaltap.php?a=<?php echo "제주";?>&location=축제&b=&page=1">제주</a>
          <ul>
            <li><a href="festivaltap.php?a=<?php echo "제주";?>&location=축제&b=1&page=1">남제주</a></li>
            <li><a href="festivaltap.php?a=<?php echo "제주";?>&location=축제&b=2&page=1">북제주</a></li>
            <li><a href="festivaltap.php?a=<?php echo "제주";?>&location=축제&b=3&page=1">서귀포</a></li>
            <li><a href="festivaltap.php?a=<?php echo "제주";?>&location=축제&b=4&page=1">제주</a></li>
          </ul>
        </li>
